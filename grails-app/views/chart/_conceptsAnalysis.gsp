                    ...
                    <g:if test="${concept.value?.commons.pvalue != null}">
                        <g:if test="${concept.value?.commons.tstat != null && concept.value?.commons.tstat != Double.NaN}">
                            <table class="stats_table">
                                <tr><td><span class="stats_title">P-Value</span></td><td>${concept.value?.commons.pvalue}</td><td><span class="stats_title">T-stat</span></td><td>${concept.value?.commons.tstat}</td></tr>
                            </table>
                        </g:if>
                        <g:elseif test="${concept.value?.commons.chisquare != null && concept.value?.commons.chisquare != Double.NaN}">
                            <table class="stats_table">
                                <tr><td><span class="stats_title">P-Value</span></td><td>${concept.value?.commons.pvalue}</td><td><span class="stats_title">χ²</span></td><td>${concept.value?.commons.chisquare}</td></tr>
                            </table>
                        </g:elseif>
                        <g:else>
                            Variable arithmetically undefined <i>(NaN)</i>
